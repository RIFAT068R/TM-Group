...
export default function AdminPanelPage() {
  ...
  return (
    <div>
      ...
      {/* Notice */}
      <div style={{ background: 'var(--brand-accent-soft)', border: '1px solid var(--brand-accent)', borderRadius: '10px', padding: '0.85rem 1.25rem', marginBottom: '1.25rem', fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 440 }}>
            ...
            <div style={{ padding: '1.25rem 0', lineHeight: 1.7 }}>
              ...
              <div style={{ background: '#FEF3C7', border: '1px solid #F59E0B', borderRadius: '8px', padding: '0.75rem 1rem', fontSize: '0.8rem', color: '#92400E' }}>
                ⚠️ <strong>Warning:</strong> This cannot be undone from this interface. To revoke, you must use the Supabase SQL Editor.
              </div>
            </div>
