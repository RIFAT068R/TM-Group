...
function FlaskIcon() { return <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-.423.442a2.25 2.25 0 01-1.63.698H6.253a2.25 2.25 0 01-1.631-.698L4.2 15.3m15.6 0a2.25 2.25 0 00.45-1.077L21 12h-3M3 12l.75 2.223A2.25 2.25 0 006 12H3zm9 5.25a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/></svg> }
