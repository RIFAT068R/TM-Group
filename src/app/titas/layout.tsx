...
import {
  GridIcon, FlaskIcon, BoxIcon, TruckIcon, UsersIcon, ReceiptIcon,
  ChartBarIcon, TrendIcon, SparklesIcon, TagIcon, CheckIcon, CogIcon,
  ShieldIcon, SwapIcon, LogoutIcon, BellIcon, MenuIcon, MoonIcon, SunIcon,
  ChevronDownIcon, CheckmarkIcon,
  ...
  useEffect(() => {
    supabase.auth.getUser().then(async ({ data }) => {
      if (data.user) {
        ...
        setUserRole(role === 'admin' ? 'Titas Admin' : 'Titas Viewer')
      }
    })
  ...
  return (
    <div className="app-shell">
      ...
      <aside
        ...
        role="navigation"
        aria-label="Titas Enterprise navigation"
      >
        {/* Workspace switcher */}
            ...
            <div className={styles.switcherLeft}>
              ...
              >
                <img
                  ...
                  alt="Titas Enterprise logo"
                  style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                  loading="lazy"
                />
              </div>
              <div>
                <div className={styles.logoName}>Titas Enterprise</div>
              ...
              <div className={styles.switcherDropdown} role="menu">
                ...
                <div className={styles.switcherItemActive} role="menuitem" aria-current="true">
                  <div className={styles.switcherItemLeft}>
                    ...
                    <span className={styles.switcherItemName}>Titas Enterprise</span>
                  </div>
                  <CheckmarkIcon />
                </div>

                {/* Switch to TM Overseas */}
                <Link
                  href="/tm/dashboard"
                  role="menuitem"
                  onClick={() => setSwitcherOpen(false)}
        ...
        <nav className="sidebar-nav" aria-label="Main navigation">
          {navItems.map(section => (
            <div key={section.section}>
              ...
              {section.items
                .filter(item => !item.adminOnly || userRole === 'Titas Admin')
                .map(item => {
      ...
      <div className="main-content">
        <header className="top-header" role="banner">
          ...
          <div className={styles.headerRight}>
            ...
            <div className={styles.moduleBadge} aria-label="Current module: Titas Enterprise">
              <span className={styles.moduleDot} aria-hidden="true" />
              <span className={styles.moduleBadgeText}>Titas Enterprise</span>
            </div>
          </div>
        </header>
